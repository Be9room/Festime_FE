  ...
  return (
    <Layout>
      <TitleBlock
        ...
        subtitle={[
          "재학생존 온라인 티켓팅에 대하여 안내드립니다.",
          "아래 내용 확인하시어 비룡제 재학생존 티켓팅에 참여해 주시길 바랍니다."
        ]}
      />
      ...
      <TitleBlock
        ...
        subtitle={[
          ...
          "인하대학교 정규등록생·부분등록생·휴학생·수료생 등 학부생",
          <span key="note" className="text-live-red">
            ※ 졸업생·대학원생·교직원·외부인은 신청 불가
          </span>,
          <br key="br" />,
          <span key="title" className="bold-14">
            • 진행 일시
          </span>,
          "9/23(월) 12:00 ~ 9/24(화) 12:00",
          <br key="br" />,
          <span key="title" className="bold-14">
            • 진행 시간
          </span>,
          ...
          "24시간의 신청 인원을 바탕으로 추첨을 진행",
          <br key="br" />,
          <span key="note" className="text-live-red">
            ※ 사전 티켓팅 링크는 9월 23일 중으로 MMS, 푸쉬알람을 통해 공지가 이뤄질 예정입니다.
          </span>,
          <span key="note" className="text-live-red">
            ※ 선착순이 아닌 추첨제를 통해 진행할 예정이니, 편하신 시간대에 참여하여 주시길 바랍니다.
          </span>
        ]}
      />
